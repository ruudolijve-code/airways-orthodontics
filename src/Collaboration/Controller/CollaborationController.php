    ...
    private function professions(): array
    {
        return [
            ...
            'fysiotherapeut' => [
                ...
                'eyebrow' => 'Houding, ademhaling, belastbaarheid en herstel',
                'headline' => 'Wanneer lokale klachten onderdeel zijn van een breder patroon.',
                'intro' => 'U ziet patiënten met een voorwaartse hoofdhouding, spanning rond nek en kaak, een hoge of inefficiënte ademhaling, beperkte inspanningstolerantie of aanhoudende vermoeidheid. Soms blijven deze klachten terugkomen, ondanks passende fysiotherapeutische begeleiding. De Airways-aanpak helpt u om houding, ademhaling, slaap, mondfunctie en de bovenste luchtweg in samenhang te bekijken en waar nodig andere disciplines te betrekken.',
                'role' => 'Als fysiotherapeut brengt u houding, bewegingsgedrag, ademhalingspatronen en belastbaarheid functioneel in kaart. U behandelt wat binnen uw expertise valt en signaleert wanneer factoren zoals neuspassage, mondademhaling, kaakontwikkeling, tongfunctie of slaap aanleiding geven tot multidisciplinaire beoordeling.',
                'education' => 'U krijgt praktische educatie in het herkennen van airway-gerelateerde patronen, het stellen van verdiepende vragen en het bepalen wanneer samenwerking met een tandarts, orthodontist, logopedist, ademfysioloog of KNO-arts meerwaarde kan hebben. Zo wordt verwijzen geen eindpunt, maar onderdeel van een gezamenlijke zorglijn.',
                'signals' => [
                    'Voorwaartse hoofdhouding en terugkerende spanning rond nek, schouders of kaak',
                    'Het gevoel onvoldoende lucht te krijgen of niet vrij te kunnen doorademen',
                    'Een hoge, oppervlakkige of overwegend orale ademhaling',
                    'Beperkte belastbaarheid of opvallend traag herstel na inspanning',
                    'Aanhoudende vermoeidheid, niet-verkwikkende slaap of slaapsignalen',
                    'Klachten die terugkeren ondanks passende fysiotherapeutische behandeling',
                ],
                'contributions' => [
                    'Houding, ademhalingsgedrag, bewegingspatronen en belastbaarheid in samenhang onderzoeken',
                    'Patiënten begeleiden binnen de eigen fysiotherapeutische expertise',
                    'Herkennen wanneer mondfunctie, neuspassage, kaakontwikkeling of slaap mede onderzocht moet worden',
                    'Gericht samenwerken met tandheelkundige, logopedische en medische disciplines',
                    'Behandeldoelen, voortgang en terugkoppeling afstemmen binnen de gezamenlijke zorglijn',
                ],
            ],
            'logopedist' => [
                'slug' => 'logopedist',
